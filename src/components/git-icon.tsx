export default function GitIcon() {
	return (
		<svg
			className="fill-foreground group-hover/github:fill-purple-700 focus-visible:fill-purple-700 dark:group-hover/github:fill-purple-500 dark:focus-visible:fill-purple-500"
